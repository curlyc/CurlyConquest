...
int tgiv1 = 5; //how many troops player 1 has to place
int tgiv2 = 5;
int tgiv3 = 5;
int tgiv4 = 5;
int tgiv5 = 5;
...
int tgivx = tgiv1;
int turnx = 0;
int urkel = 0; //turn phase 0 get turn gift, 1 place, 2 attack 3 move
int goliath = 0;
int david = 0;
int cancan = 0;
...
void TgivT() {
  if (urkel == 1) {
          if ((a1o == turn) && (a2o == turn) && (a3o == turn) && (a4o == turn)) { tgivx += 8; }
          if ((b1o == turn) && (b2o == turn)) { tgivx += 4; }
          if ((c1o == turn) && (c2o == turn) && (c3o == turn)) { tgivx += 6; }
          if ((d1o == turn) && (d2o == turn) && (d3o == turn) && (d4o == turn)) { tgivx += 8; }
          if ((e1o == turn) && (e2o == turn) && (e3o == turn) && (e4o == turn) && (e5o == turn) && (e6o == turn)) { tgivx += 12; }
          if ((f1o == turn) && (f2o == turn) && (f3o == turn)) { tgivx += 6; }
          if ((g1o == turn) && (g2o == turn) && (g3o == turn) && (g4o == turn)) { tgivx += 8; }
          tgivx += turnx;
          urkel = 2;
  }
}
...
void Dng() {
     if ((a1s == 1) && (ab.pressed(B_BUTTON))) { // stuff a1 can attack
       if ((xloc == 107) && (yloc == 7)) { //if cursor is over e2 
        e2s = 2;
       }
       if ((xloc == 13) && (yloc == 15)) { //if cursor is over a2
        a2s = 2;
       }
   }

   if ((a2s == 1) && (ab.pressed(B_BUTTON))) { // stuff a2 can attack
       if ((xloc == 4) && (yloc == 6)) { //if cursor is over a1 
        a1s = 2;
       }
       if ((xloc == 22) && (yloc == 11)) { //if cursor is over a3
        a3s = 2;
       }
       if ((xloc == 13) && (yloc == 26)) { //if cursor is over b1
        b1s = 2;
       }
   }
   if ((a3s == 1) && (ab.pressed(B_BUTTON))) { // stuff a3 can attack
       if ((xloc == 13) && (yloc == 15)) { //if cursor is over a2 
        a2s = 2;
       }
       if ((xloc == 30) && (yloc == 6)) { //if cursor is over a4
        a4s = 2;
       }
   }
   if ((a4s == 1) && (ab.pressed(B_BUTTON))) { // stuff a4 can attack
       if ((xloc == 22) && (yloc == 11)) { //if cursor is over a3 
        a3s = 2;
       }
       if ((xloc == 45) && (yloc == 3)) { //if cursor is over d1
        d1s = 2;
       }
   } // CENTRAL AMERICA
   if ((b1s == 1) && (ab.pressed(B_BUTTON))) { // stuff b1 can attack
       if ((xloc == 17) && (yloc == 31)) { //if cursor is over b2 
        b2s = 2;
       }
       if ((xloc == 13) && (yloc == 15)) { //if cursor is over a2
        a2s = 2;
   ...
   if ((b2s == 1) && (ab.pressed(B_BUTTON))) { // stuff b2 can attack
       if ((xloc == 13) && (yloc == 26)) { //if cursor is over b1 
        b1s = 2;
       }
       if ((xloc == 24) && (yloc == 32)) { //if cursor is over c1
        c1s = 2;
       }
   } // SOUTH AMERICA
   if ((c1s == 1) && (ab.pressed(B_BUTTON))) { // stuff c1 can attack
       if ((xloc == 17) && (yloc == 31)) { //if cursor is over b2 
        b2s = 2;
       }
       if ((xloc == 30) && (yloc == 38)) { //if cursor is over c2
        c2s = 2;
       }
   }
   if ((c2s == 1) && (ab.pressed(B_BUTTON))) { // stuff c2 can attack
       if ((xloc == 24) && (yloc == 32)) { //if cursor is over c1 
        c1s = 2;
       }
       if ((xloc == 28) && (yloc == 49)) { //if cursor is over c3
        c3s = 2;
       }
       if ((xloc == 57) && (yloc == 24)) { //if cursor is over g1
        g1s = 2;
       }
    //EUROPE
    if ((d1s == 1) && (ab.pressed(B_BUTTON))) { // stuff d1 can attack
       if ((xloc == 30) && (yloc == 6)) { //if cursor is over a4 
        a4s = 2;
       }
       if ((xloc == 62) && (yloc == 10)) { //if cursor is over d2 
        d2s = 2;
       }
   }
  
}
} //uh im not shure why this has to be here, but im assuming something before here is horribly wrong
void setup() {
...
if (!(ab.nextFrame()))
    ...
    if (gamestate == 2) {
      ...
      // URKEL
      //DIIIIIIIIIID I DO THAAAAAAAAAAAAAAAAAAAAAT?
      //pass the turn if urkel = 0 and tgivx = 0
      if ((urkel == 0) && (tgivx == 0)) {
      turn += 1;
      }
      if ((urkel == 1) && (tgivx == 0)) {
      ...
      // ATTACK PHASE
      if (urkel == 2) {
        // ooooooooooooh boy nowza time 4 attackin
      }
      // urkel = 1 if all players have distributed there units
      if ((urkel == 0) && (tgiv1 == 0) && (tgiv2 == 0) && (tgiv3 == 0) && (tgiv4 == 0) && (tgiv5 == 0) && (tgiv6 == 0)) {
      ...
      // AFRICA
       if ((xloc == 75) && (yloc == 43) && ab.everyXFrames(13))  { //if at G4 and press LEFT
        xloc = 65; //move to  G3
        yloc = 44; 
        own = g3o; //what player owns terirory cursor is over
        troo = g3; // how many troopers are stationed there
      }
       if ((xloc == 57) && (yloc == 24) && ab.everyXFrames(13))  { //if at G1 and press LEFT
        xloc = 30; //move to  c2
        yloc = 38; 
     ...
     if ((xloc == 76) && (yloc == 20) && ab.everyXFrames(23))  { //if at D4 and press LEFT
      ...
      //AUS LEFT
      if ((xloc == 113) && (yloc == 46) && ab.everyXFrames(18))  { //if at e4 and press LEFT
        xloc = 106; //move to F2
        yloc = 45; 
    ...
    if (ab.pressed(RIGHT_BUTTON)) {
      if ((xloc == 4) && (yloc == 6) && ab.everyXFrames(26))  { //if at a1 and press right
        xloc = 13; //move to  a2
        yloc = 15;
        own = a2o; //what player owns terirory cursor is over
        troo = a2; // how many troopers are stationed there
      ...
      if ((xloc == 13) && (yloc == 15)&& ab.everyXFrames(25))  { //if at a2 and press right
        xloc = 22; //move to  a3
        yloc = 11;
        own = a3o; //what player owns terirory cursor is over
        troo = a3; // how many troopers are stationed there
       ...
       if ((xloc == 22) && (yloc == 11) && ab.everyXFrames(24))  { //if at a3 and press right
        xloc = 30; //move to A4
        yloc = 6;
        own = a4o; //what player owns terirory cursor is over
        troo = a4; // how many troopers are stationed there
      }
       if ((xloc == 30) && (yloc == 6) && ab.everyXFrames(23))  { //if at a4 and press right
        xloc = 45; //move to  D1
        yloc = 3;
        own = d1o; //what player owns terirory cursor is over
        troo = d1; // how many troopers are stationed there
      ...
      // ASIA
        if ((xloc == 107) && (yloc == 7) && ab.everyXFrames(22))  { //if at e2 and press right
        xloc = 4; //move to  a1
        yloc = 6; 
        own = a1o; //what player owns terirory cursor is over
        troo = a1; // how many troopers are stationed there
      }
       if ((xloc == 93) && (yloc == 8) && ab.everyXFrames(19))  { //if at E1 and press right
        xloc = 107; //move to  E2
        yloc = 7;
        own = e2o; //what player owns terirory cursor is over
    ...
    //SOUTH AMERICA
       if ((xloc == 30) && (yloc == 38) && ab.everyXFrames(27))  { //if at c2 and press left
        xloc = 57; //move to  g1
        yloc = 24;
        own = g1o; //what player owns terirory cursor is over
        troo = g1; // how many troopers are stationed there
    ...
    // AFRICA
      if ((xloc == 65) && (yloc == 44) && ab.everyXFrames(13))  { //if at G3 and press RIGHT
        xloc = 75; //move to  G4
        yloc = 43; 
        own = g4o; //what player owns terirory cursor is over
        troo = g4; // how many troopers are stationed there
      }
       if ((xloc == 66) && (yloc == 33) && ab.everyXFrames(20))  { //if at G2 and press RIGHT
        xloc = 76; //move to  d4
        yloc = 20;
        own = d4o; //what player owns terirory cursor is over
        troo = d4; // how many troopers are stationed there 
      }
       if ((xloc == 57) && (yloc == 24) && ab.everyXFrames(20))  { //if at G1 and press RIGHT
        xloc = 76; //move to  d4
        yloc = 20;
        own = d4o; //what player owns terirory cursor is over
        troo = d4; // how many troopers are stationed there  
    ...
    //EUROPE RIGHT
        if ((xloc == 45) && (yloc == 3) && ab.everyXFrames(15))  { //if at D1 and press right
        xloc = 62; //move to  D2
        yloc = 10;
        own = d2o; //what player owns terirory cursor is over
        troo = d2; // how many troopers are stationed there 
      }
       if ((xloc == 62) && (yloc == 10) && ab.everyXFrames(19))  { //if at D2 and press right
        xloc = 75; //move to  D3
        yloc = 9;
        own = d3o; //what player owns terirory cursor is over
        troo = d3; // how many troopers are stationed there 
      }
        if ((xloc == 75) && (yloc == 9) && ab.everyXFrames(10))  { //if at D3 and press right
        xloc = 93; //move to  E1
        yloc = 8;
        own = e1o; //what player owns terirory cursor is over
        troo = e1; // how many troopers are stationed there 
      }  
       if ((xloc == 76) && (yloc == 20) && ab.everyXFrames(15))  { //if at D4 and press right
        xloc = 95; //move to  E6
        yloc = 19;
        own = e6o; //what player owns terirory cursor is over
        troo = e6; // how many troopers are stationed there 
      ...
      //ASIA RIGHT
      if ((xloc == 95) && (yloc == 19) && ab.everyXFrames(15))  { //if at E6 and press right
        xloc = 110; //move to  E3 JAPAN
        yloc = 15;
        own = e3o; //what player owns terirory cursor is over
        troo = e3; // how many troopers are stationed there 
      }
      if ((xloc == 106) && (yloc == 29) && ab.everyXFrames(15))  { //if at E4 and press right
        xloc = 115; //move to  F1? 
        yloc = 37;
      ...
      //AUS RIGHT
      if ((xloc == 106) && (yloc == 45) && ab.everyXFrames(15))  { //if at F2 and press right
        xloc = 113; //move to  F3? 
        yloc = 46;
      ...
      if (ab.pressed(UP_BUTTON)) {
       if ((xloc == 13) && (yloc == 26) && ab.everyXFrames(22))  { //if at b1 and press UP
        xloc = 13; //move to  a2
        yloc = 15; 
        own = a2o; //what player owns terirory cursor is over
        troo = a2; // how many troopers are stationed there 
      }
        if ((xloc == 17) && (yloc == 31) && ab.everyXFrames(21))  { //if at b2 and press UP
        xloc = 13; //move to  B1
        yloc = 26; 
      ...
      // SOUTH AMERICA UP
      if ((xloc == 28) && (yloc == 49) && ab.everyXFrames(20))  { //if at C3 and press UP
        xloc = 30; //move to C2
        yloc = 38; 
        own = c2o; //what player owns terirory cursor is over
        troo = c2; // how many troopers are stationed there 
      }
      if ((xloc == 30) && (yloc == 38) && ab.everyXFrames(19))  { //if at C2 and press UP
        xloc = 24; //move to C1
        yloc = 32;
        own = c1o; //what player owns terirory cursor is over
        troo = c1; // how many troopers are stationed there  
      }
      if ((xloc == 24) && (yloc == 32) && ab.everyXFrames(18))  { //if at c1 and press UP
        xloc = 17; //move to b2
        yloc = 31; 
      ...
      //AFRICA UP
       if ((xloc == 65) && (yloc == 44) && ab.everyXFrames(20))  { //if at G3 and press UP
        xloc = 66; //move to G2
        yloc = 33; 
        own = g2o; //what player owns terirory cursor is over
        troo = g2; // how many troopers are stationed there 
      }
       if ((xloc == 66) && (yloc == 33) && ab.everyXFrames(25))  { //if at G2 and press UP
        xloc = 57; //move to G1
        yloc = 24; 
        own = g1o; //what player owns terirory cursor is over
        troo = g1; // how many troopers are stationed there 
      ...
      //EUROPE UP
      if ((xloc == 76) && (yloc == 20) && ab.everyXFrames(25))  { //if at D4 and press UP
        xloc = 75; //move to D3
        yloc = 9; 
        own = d3o; //what player owns terirory cursor is over
        troo = d3; // how many troopers are stationed there 
      ...
      //ASIA UP
      // JAPAN UP
      if ((xloc == 110) && (yloc == 15) && ab.everyXFrames(28))  { //if at E3 and press UP
        xloc = 107; //move to E2
        yloc = 7; 
        own = e2o; //what player owns terirory cursor is over
        troo = e2; // how many troopers are stationed there 
      }
      if ((xloc == 102) && (yloc == 35) && ab.everyXFrames(28))  { //if at E5 and press UP
        xloc = 95; //move to E6
        yloc = 19; 
        own = e6o; //what player owns terirory cursor is over
        troo = e6; // how many troopers are stationed there 
      }
     if ((xloc == 106) && (yloc == 29) && ab.everyXFrames(28))  { //if at E4 and press UP
        xloc = 110; //move to E3
        yloc = 15;
        own = e3o; //what player owns terirory cursor is over
        troo = e3; // how many troopers are stationed there  
      ...
      // AUS UP
      if ((xloc == 106) && (yloc == 45) && ab.everyXFrames(25))  { //if at F2 and press UP
        xloc = 102; //move to E5
        yloc = 35; 
        own = e5o; //what player owns terirory cursor is over
        troo = e5; // how many troopers are stationed there 
      }
      if ((xloc == 95) && (yloc == 19) && ab.everyXFrames(24))  { //if at E6 and press UP
        xloc = 93; //move to E1
        yloc = 8; 
        own = e1o; //what player owns terirory cursor is over
        troo = e1; // how many troopers are stationed there 
      }
       if ((xloc == 113) && (yloc == 46) && ab.everyXFrames(25))  { //if at F3 and press UP
        xloc = 115; //move to F1
        yloc = 37; 
        own = f1o; //what player owns terirory cursor is over
        troo = f1; // how many troopers are stationed there 
      }
      if ((xloc == 115) && (yloc == 37) && ab.everyXFrames(24))  { //if at F1 and press UP
        xloc = 106; //move to e4
        yloc = 29; 
    ...
    if (ab.pressed(DOWN_BUTTON)) {
       if ((xloc == 13) && (yloc == 15) && ab.everyXFrames(17))  { //if at a2 and press down
        xloc = 13; //move to  b1
        yloc = 26; 
        own = b1o; //what player owns terirory cursor is over
        troo = b1; // how many troopers are stationed there 
      }
       if ((xloc == 13) && (yloc == 26) && ab.everyXFrames(16))  { //if at B1 and press down
        xloc = 17; //move to  b2
        yloc = 31;
        own = b2o; //what player owns terirory cursor is over
        troo = b2; // how many troopers are stationed there  
      }
      if ((xloc == 17) && (yloc == 31) && ab.everyXFrames(15))  { //if at B2 and press down
        xloc = 24; //move to  C1
        yloc = 32; 
        own = c1o; //what player owns terirory cursor is over
        troo = c1; // how many troopers are stationed there 
      ...
      //SOUTH AMERICA
      if ((xloc == 24) && (yloc == 32) && ab.everyXFrames(14))  { //if at C1 and press down
        xloc = 30; //move to  C2
        yloc = 38; 
        own = c2o; //what player owns terirory cursor is over
        troo = c2; // how many troopers are stationed there 
      }
      if ((xloc == 30) && (yloc == 38) && ab.everyXFrames(13))  { //if at C2 and press down
        xloc = 28; //move to  C3
        yloc = 49;
      ...
      // AFRICA
      if ((xloc == 57) && (yloc == 24) && ab.everyXFrames(15))  { //if at G1 and press down
        xloc = 66; //move to  G2
        yloc = 33; 
        own = g2o; //what player owns terirory cursor is over
        troo = g2; // how many troopers are stationed there 
      }
       if ((xloc == 66) && (yloc == 33) && ab.everyXFrames(17))  { //if at G1 and press down
        xloc = 65; //move to  G3
        yloc = 44;
        own = g3o; //what player owns terirory cursor is over
        troo = g3; // how many troopers are stationed there  
    ...
    //END AFRICA DOWN
    //EUROPE DOWN
     if ((xloc == 75) && (yloc == 9) && ab.everyXFrames(17))  { //if at D3 and press down
        xloc = 76; //move to  D4
        yloc = 20;
        own = d4o; //what player owns terirory cursor is over
        troo = d4; // how many troopers are stationed there  
      }
     if ((xloc == 76) && (yloc == 20) && ab.everyXFrames(17))  { //if at D4 and press down
        xloc = 66; //move to  g2
        yloc = 33; 
        own = g2o; //what player owns terirory cursor is over
        troo = g2; // how many troopers are stationed there 
      ...
      //ASIA DOWN
      //E1 TO E6
      if ((xloc == 93) && (yloc == 8) && ab.everyXFrames(26))  { //if at E1 and press DOWN
        xloc = 95; //move to E6
        yloc = 19; 
        own = e6o; //what player owns terirory cursor is over
        troo = e6; // how many troopers are stationed there 
      ...
      //E2 TO JAPAN
      if ((xloc == 107) && (yloc == 7) && ab.everyXFrames(26))  { //if at E2 and press DOWN
        xloc = 110; //move to E3
        yloc = 15; 
        own = e3o; //what player owns terirory cursor is over
        troo = e3; // how many troopers are stationed there 
      ...
      //E3 TO E4
      if ((xloc == 110) && (yloc == 15) && ab.everyXFrames(25))  { //if at E3 and press DOWN
        xloc = 106; //move to E4
        yloc = 29; 
        own = e4o; //what player owns terirory cursor is over
        troo = e4; // how many troopers are stationed there 
      ...
      //E5 TO E5
      if ((xloc == 106) && (yloc == 29) && ab.everyXFrames(24))  { //if at E1 and press DOWN
        xloc = 102; //move to E5
        yloc = 35; 
        own = e5o; //what player owns terirory cursor is over
        troo = e5; // how many troopers are stationed there 
      ...
      //E6 TO E5
      if ((xloc == 95) && (yloc == 19) && ab.everyXFrames(25))  { //if at E5 and press DOWN
        xloc = 102; //move to E6
        yloc = 35; 
        own = e6o; //what player owns terirory cursor is over
        troo = e6; // how many troopers are stationed there 
      ...
      //E5 TO  F2?
    if ((xloc == 102) && (yloc == 35) && ab.everyXFrames(24))  { //if at E5 and press DOWN
        xloc = 106; //move to F2?
        yloc = 45; 
        own = f2o; //what player owns terirory cursor is over
        troo = f2; // how many troopers are stationed there 
      ...
      //AUS DOWN
      if ((xloc == 115) && (yloc == 37) && ab.everyXFrames(20))  { //if at F1 and press DOWN
        xloc = 113; //move to F3?
        yloc = 46;
        own = f3o; //what player owns terirory cursor is over
        troo = f3; // how many troopers are stationed there  
